package plus.dragons.create_central_kitchen.foundation.data;
...
import plus.dragons.create_central_kitchen.foundation.data.loot.BlockLootTables;
import plus.dragons.create_central_kitchen.foundation.data.recipe.provider.*;
import plus.dragons.create_central_kitchen.foundation.data.tag.ForgeBlockTags;
import plus.dragons.create_central_kitchen.foundation.data.tag.ForgeItemTags;
import plus.dragons.create_central_kitchen.foundation.data.tag.IntegrationBlockTags;
import plus.dragons.create_central_kitchen.foundation.data.tag.IntegrationItemTags;
